...
///Reallocate given buffer to double capacity.
/**
 ...
 */
#define REALLOCATE(buf, cap, size, type)\
{\
    cap *= 2;\
...
///Get a string to be used for inserting or searching from a ptr to INISection.
/**
...
///Get a string to be used for inserting or searching from a char pointer.
/**
 ...
 */
template <typename T>
inline void Insert(T * * array, const ui length, register T * elem)
{
