...
static const GUI_WIDGET_CREATE_INFO _aDialog[] = {
  { FRAMEWIN_CreateIndirect, "Performance", ID_FRAMEWIN_CPU, 0, 0, 320, 240-25, FRAMEWIN_CF_MOVEABLE, 0 },
  { TEXT_CreateIndirect, "00000000 Pixels/s ", ID_TEXT_CPU, 70, 135, 300, 25, 0, 0, 0 }, 
  { BUTTON_CreateIndirect, "Start Speed Benchmark", ID_BENCH_CPU, 80 , 160 , 160, 30, 0, 0, 0 },  
};
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    hItem = TEXT_CreateEx(5, 20, 100, 25, pMsg->hWin, WM_CF_SHOW,0, 0x123,"");
    ...
    hGraph = GRAPH_CreateEx(10, 35, 300, 115, pMsg->hWin, WM_CF_SHOW, 0, GUI_ID_GRAPH0);
    hData = GRAPH_DATA_YT_Create(GUI_LIGHTGREEN, 500, 0, 20);
    GRAPH_SetGridVis(hGraph, 1);
    GRAPH_SetBorder(hGraph, 25, 2, 2, 2); 
    ...
    WM_CreateWindowAsChild(0, 20, 320, 50, pMsg->hWin, WM_CF_SHOW | WM_CF_HASTRANS, _cbCpuWindow , 0); 
