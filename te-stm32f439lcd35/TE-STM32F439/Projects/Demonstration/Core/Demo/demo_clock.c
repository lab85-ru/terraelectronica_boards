...
static const GUI_WIDGET_CREATE_INFO _aDialog[] = {
  { FRAMEWIN_CreateIndirect, "Clock", ID_FRAMEWIN_CLOCK, 0, 0, 320, 240-20, FRAMEWIN_CF_MOVEABLE|WM_CF_STAYONTOP, 0 },
  { TEXT_CreateIndirect, "", ID_TEXT_DATE, 140, 0, 180, 23, 0, 0, TEXT_CF_HCENTER },
  { TEXT_CreateIndirect, "", ID_TEXT_CLOCK, 40, 0, 160, 60, 0, 0, 0 },  
  { BUTTON_CreateIndirect, "Close", ID_BUTTON_CLOSE_CLOCK, 250, 80, 50, 24, 0, 0, 0 },
  { BUTTON_CreateIndirect, "Settings", ID_BUTTON_SETTINGS_CLOCK, 250, 130, 50, 24, 0, 0, 0},
};

static const GUI_WIDGET_CREATE_INFO _aDialogSettingsCreate[] = {
  { FRAMEWIN_CreateIndirect, "Settings", ID_FRAMEWIN_SETTINGS, 0, 0, 320, 240-20, FRAMEWIN_CF_MOVEABLE|WM_CF_STAYONTOP, 0},
  { BUTTON_CreateIndirect, "Cancel", ID_CLOSE_SETTINGS, 120, 150, 80, 24, 0, 0, 0 },
  { BUTTON_CreateIndirect, "Apply", ID_SET_SETTINGS, 20, 150, 80, 24, 0, 0, 0},
};
...
static const GUI_WIDGET_CREATE_INFO _aDialogNumPad[] = {
  ...
  { WINDOW_CreateIndirect,   0,        0, 320-95, 240-130,  95, 130},
...
static void _cbDialogSettings(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    hItem = CHECKBOX_Create(190, 65 + 20, 20, 26, pMsg->hWin, ID_CLOCK_CHECK_TIME ,WM_CF_SHOW);
    CHECKBOX_SetState(hItem, 1);
    ...
    hItem = CHECKBOX_Create(190, 93 + 40, 20, 26, pMsg->hWin, ID_CLOCK_CHECK_ALARM ,WM_CF_SHOW);
    CHECKBOX_SetState(hItem, 1);
    SPINBOX_EnableBlink(hSpin, 250, 1);
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    TEXT_SetFont(hItem, &GUI_FontComic18B_1);
    TEXT_SetTextColor(hItem, 0x00F04000);
    ...
    CALENDAR_Create(pMsg->hWin, 15, 40, year, month, day, 2, ID_CALENDAR, WM_CF_SHOW);
