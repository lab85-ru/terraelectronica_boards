...
static const GUI_WIDGET_CREATE_INFO _aDialog[] = {
  { FRAMEWIN_CreateIndirect, "System Information", ID_FRAMEWIN_INFO, 0, 0, 320, 240-20, WM_CF_STAYONTOP, 0 },
  { IMAGE_CreateIndirect, "Image", ID_IMAGE_INFO, 210, 5, 90, 90, 0, 0, 0 },  
  { TEXT_CreateIndirect, "Board : TE-STM32F439LCD35", ID_TEXT_BOARD, 5, 10, 200, 23, 0, 0, 0 },
  { TEXT_CreateIndirect, "MCU: STM32F439ZIT6", ID_TEXT_MCU, 5, 30, 226, 30, 0, 0, 0 },
  { TEXT_CreateIndirect, "Core: CortexM4F", ID_TEXT_CORE, 5, 50, 226, 30, 0, 0, 0 },
  { TEXT_CreateIndirect, "CPU Speed: 180MHz", ID_TEXT_COPYRIGHT, 5, 70, 238, 22, 0, 0, 0 },  
  { TEXT_CreateIndirect, "SDRAM: 32Mb", ID_TEXT_SDRAM, 5, 90, 238, 22, 0, 0, 0 },  
  { TEXT_CreateIndirect, "Firmware Version: 2.0", ID_TEXT_CPU, 5, 110, 288, 38, 0, 0, 0 },
  { TEXT_CreateIndirect, "Copyright 2014 Terraelectronica", ID_TEXT_VERSION, 5, 130, 323, 20, 0, 0, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    /* Initialization of 'MCU: STM32F-4 Series' */
    ...
    hItem = WM_GetDialogItem(pMsg->hWin, ID_TEXT_SDRAM);
    TEXT_SetFont(hItem, GUI_FONT_13HB_ASCII);
    TEXT_SetTextColor(hItem, 0x00804000);
