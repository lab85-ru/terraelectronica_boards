/**
  @page FMC_NOR NOR flash memory basic functionalities use example
...
@par Example Description 
  ...
  This basic example shows how to perform erase/read/write operations on the M29W128GL 
