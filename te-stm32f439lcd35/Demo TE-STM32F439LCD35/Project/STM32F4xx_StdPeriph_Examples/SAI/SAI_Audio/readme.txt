...
@par Directory contents 
  ...
  - SAI/SAI_Audio/audio_sample.c      Audio Sample file (in tab format)
...
@par Hardware and Software environment 
  ...
  - This example has been tested with STMicroelectronics STM324x9I-EVAL(STM32F429x/439x Devices) 
...
In order to make the program work, you must do the following :
 ...
 - STM324x9I_EVAL Workspace : 
    - Add the files "stm324x9i_eval_audio_codec.c" to the project source list this file 
      is located under Utilities\STM32_EVAL\STM324x9I_EVAL       
