...
#define S0SPCR                    SFR_IO32(SPI_BASE_ADDR + 0x000)
...
#define S0SPSR                    SFR_IO32(SPI_BASE_ADDR + 0x004)
#define S0SPSR_ABRT               (3)
#define S0SPSR_MODF               (4)
#define S0SPSR_ROVR               (5)
#define S0SPSR_WCOL               (6)
#define S0SPSR_SPIF               (7)
#define S0SPDR                    SFR_IO32(SPI_BASE_ADDR + 0x008)
#define S0SPCCR                   SFR_IO32(SPI_BASE_ADDR + 0x00C)
#define S0SPINT                   SFR_IO32(SPI_BASE_ADDR + 0x01C)
...
#define MCIFifo                   SFR_IO32(MCI_BASE_ADDR + 0x080)
...
#define PCLKSEL0_WDT              (0)
#define PCLKSEL0_TIMER0           (2)
#define PCLKSEL0_TIMER1           (4)
#define PCLKSEL0_UART0            (6)
#define PCLKSEL0_UART1            (8)
#define PCLKSEL0_PWM0             (10)
#define PCLKSEL0_PWM1             (12)
#define PCLKSEL0_I2C0             (14)
#define PCLKSEL0_SPI              (16)
#define PCLKSEL0_RTC              (18)
#define PCLKSEL0_SSP1             (20)
#define PCLKSEL0_DAC              (22)
#define PCLKSEL0_ADC              (24)
#define PCLKSEL0_CAN1             (26)
#define PCLKSEL0_CAN2             (28)
#define PCLKSEL0_ACF              (30)
#define PCLKSEL1                  SFR_IO32(SCB_BASE_ADDR + 0x1AC)
#define PCLKSEL1_BAT_RAM          (0)
#define PCLKSEL1_GPIO             (2)
#define PCLKSEL1_PCB              (4)
#define PCLKSEL1_I2C1             (6)
#define PCLKSEL1_SSP0             (10)
#define PCLKSEL1_TIMER2           (12)
#define PCLKSEL1_TIMER3           (14)
#define PCLKSEL1_UART2            (16)
#define PCLKSEL1_UART3            (18)
#define PCLKSEL1_I2C2             (20)
#define PCLKSEL1_I2S              (22)
#define PCLKSEL1_MCI              (24)
#define PCLKSEL1_SYSCON           (28)
/* Power control */
...
#define DMACIntStatus                   SFR_IO32(DMA_BASE_ADDR + 0x000)
#define DMACIntTCStatus                 SFR_IO32(DMA_BASE_ADDR + 0x004)
#define DMACIntTCClear                  SFR_IO32(DMA_BASE_ADDR + 0x008)
#define DMACIntErrorStatus              SFR_IO32(DMA_BASE_ADDR + 0x00C)
#define DMACIntErrClr                   SFR_IO32(DMA_BASE_ADDR + 0x010)
#define DMACRawIntTCStatus              SFR_IO32(DMA_BASE_ADDR + 0x014)
#define DMACRawIntErrorStatus           SFR_IO32(DMA_BASE_ADDR + 0x018)
#define DMACEnbldChns                   SFR_IO32(DMA_BASE_ADDR + 0x01C)
#define DMACSoftBReq                    SFR_IO32(DMA_BASE_ADDR + 0x020)
#define DMACSoftSReq                    SFR_IO32(DMA_BASE_ADDR + 0x024)
#define DMACSoftLBReq                   SFR_IO32(DMA_BASE_ADDR + 0x028)
#define DMACSoftLSReq                   SFR_IO32(DMA_BASE_ADDR + 0x02C)
#define DMACConfiguration               SFR_IO32(DMA_BASE_ADDR + 0x030)
#define DMACSync                        SFR_IO32(DMA_BASE_ADDR + 0x034)
// Channel 0
#define DMACC0SrcAddr                   SFR_IO32(DMA_BASE_ADDR + 0x100)
#define DMACC0DestAddr                  SFR_IO32(DMA_BASE_ADDR + 0x104)
#define DMACC0LLI                       SFR_IO32(DMA_BASE_ADDR + 0x108)
#define DMACC0Control                   SFR_IO32(DMA_BASE_ADDR + 0x10C)
#define DMACC0Configuration             SFR_IO32(DMA_BASE_ADDR + 0x110)
// Channel 1
#define DMACC1SrcAddr                   SFR_IO32(DMA_BASE_ADDR + 0x120)
#define DMACC1DestAddr                  SFR_IO32(DMA_BASE_ADDR + 0x124)
#define DMACC1LLI                       SFR_IO32(DMA_BASE_ADDR + 0x128)
#define DMACC1Control                   SFR_IO32(DMA_BASE_ADDR + 0x12C)
#define DMACC1Configuration             SFR_IO32(DMA_BASE_ADDR + 0x130)
