...
static tStripChartAxis i16Axis16X =
{
    ...
    127,                                     // maximum value for the axis
...
static tStripChartAxis i16Axis16Y =
{
    ...
    -47,                                    // minimum value for the axis
    47,                                     // maximum value for the axis
...
//
//*****************************************************************************
StripChart(g_sStripChart, WIDGET_ROOT, 0, 0, &g_sNOKIA128X160, 0, 0, 128, 160,
...
main(void)
{
    ...
    //
    // Set the clocking to run directly at 80 MHz.
    //
    ...
    //
    GrOffScreen4BPPInit(&g_sOffscreenDisplay, g_pui8OffscreenBuf, 128, 160);
    ...
    while(1)
    {
        ...
        //
        g_i8SeriesData[ui16ItemCount - 1] = (int8_t)(fSine * 80.0);
