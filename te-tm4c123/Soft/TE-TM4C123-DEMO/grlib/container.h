...
//
//*****************************************************************************
#define ContainerStruct(psParent, psNext, psChild, psDisplay, i32X, i32Y,     \
...
//
//*****************************************************************************
#define Container(sName, psParent, psNext, psChild, psDisplay, i32X, i32Y,    \
                  i32Width, i32Height, ui32Style, ui32FillColor,              \
                  ui32OutlineColor, ui32TextColor, psFont, pcText)            \
        tContainerWidget sName =                                              \
            ContainerStruct(psParent, psNext, psChild, psDisplay, i32X, i32Y, \
                            i32Width, i32Height, ui32Style, ui32FillColor,    \
                            ui32OutlineColor, ui32TextColor, psFont, pcText)
...
//
//*****************************************************************************
extern int32_t ContainerMsgProc(tWidget *psWidget, uint32_t ui32Msg,
