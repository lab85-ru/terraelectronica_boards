//*****************************************************************************
//
// 	LIS302DL.c - Driver for MEMS digital output motion sensor.
...
#define MOTION_SSI_CLOCK           5000000
...
//*****************************************************************************
 void
LIS302DL_Write_Reg(uint8_t Adr_Reg, uint8_t Data)
{
...
//
//*****************************************************************************
uint32_t LIS302DL_Read_Reg(uint8_t Adr_Reg)
{
    uint32_t ulDataRx;
		while(ROM_SSIBusy(MOTION_SSI_BASE));
