...
//
//*****************************************************************************
SlideMenu(g_sFileMenuWidget, WIDGET_ROOT, 0, 0, &g_sNOKIA128X160, 0, 0, 128, 160,
...
ShowStatusScreen(char *pcStatus[], uint32_t ui32Count)
{
    ...
    GrStringDrawCentered(&sContext, "USB-HOST-MSC sample", -1,
...
main(void)
{
    ...
    //
    GrOffScreen4BPPInit(&g_sOffscreenDisplayA, g_pui8OffscreenBufA, 128, 160);
    GrOffScreen4BPPPaletteSet(&g_sOffscreenDisplayA, g_pui32Palette, 0,
                              NUM_PALETTE_ENTRIES);
    GrOffScreen4BPPInit(&g_sOffscreenDisplayB, g_pui8OffscreenBufB, 128, 160);
